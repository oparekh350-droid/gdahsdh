    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="businessName" defaultValue={authService.getBusinessData()?.name || ""} />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="ownerName" defaultValue={authService.getCurrentUser()?.name || ""} />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" defaultValue={authService.getCurrentUser()?.email || ""} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="phone">Phone</Label>
                  <Input id="phone" type="tel" defaultValue={authService.getBusinessData()?.phone || ""} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="businessNumber" type="tel" required pattern="^[+0-9]{7,15}$" placeholder="e.g. +91 9876543210" />
                <p className="text-xs text-gray-500">7–15 digits, numbers and optional + only.</p>
              </div>
          ...
          {/* AI Assistant Configuration (hidden) */}
          ...
          <div className="hidden"><WhatsAppConfig /></div>
        ...
        <div className="fixed bottom-0 inset-x-0 z-40 md:hidden px-4 pb-[env(safe-area-inset-bottom)] pt-2 bg-white/95 backdrop-blur border-t shadow-lg">
          <div className="flex gap-2">
            <Button onClick={handleSave} disabled={isSaving} className="flex-1 bg-blue-600 hover:bg-blue-700">
              {isSaving ? <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div> : <Save className="w-4 h-4 mr-2" />}
              Save Changes
            </Button>
          </div>
        </div>
